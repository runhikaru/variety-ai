          ...
          ? Center(
              child: ListView(
                children: [
                  ...
                  ListTile(
                    leading: const Text("手順１", style: leadingStyle2),
                    title: checkPlatform()
                        ? const Text(
                            "「OK グーグル」と言ってみよう",
                            style: TextStyle(fontSize: 30),
                  ...
                  ListTile(
                    leading: const Text("手順２", style: leadingStyle2),
                  ...
                  ListTile(
                    leading: const Text("手順４", style: leadingStyle2),
                    title: ElevatedButton(
                        onPressed: () {
                          setState(() {
                        ...
                        child: const Text("入力したテキストを読ませる")),
                  ),
                ],
              ),
            )
